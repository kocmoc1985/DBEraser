 ...
 */
public class FixedQueryTool_SAPCPMD extends javax.swing.JFrame implements Runnable {
    ...
    private void initComponents() {
        ...
        jButton5.setText("vendor_contact");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        CURRENT_QUERY = "select * from item_price_b";
        run_query_by_thread();
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        CURRENT_QUERY = "select * from vendor_b";
        run_query_by_thread();
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        CURRENT_QUERY = "select * from vendor_contact_b";
        run_query_by_thread();
    }//GEN-LAST:event_jButton5ActionPerformed

    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        CURRENT_QUERY = "select * from interface_trigger_back";
        run_query_by_thread();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            Logger.getLogger(FixedQueryTool_SAPCPMD.class.getName()).log(Level.SEVERE, null, ex);
        }
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new FixedQueryTool_SAPCPMD().setVisible(true);
            }
        });
    }
