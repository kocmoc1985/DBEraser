...
public class Faktura_Entry_Insert_ extends Faktura_Entry {
    ...
    public Faktura_Entry_Insert_(Invoice_ invoice) {
        super(invoice);
    }
...
//            System.out.println("FAKTURA ID AQUIRED: " + fakturaId);
    ...
    protected void setData() {
        ...
        this.fakturaMap.put(DB.BUH_FAKTURA__FAKTURANR__, Invoice_.getNextFakturaNr(kundId)); // OBS! Aquired from http
        //
...
//        JSon.hashMapToJSON(this.fakturaMap); // Temporary here
    ...
    protected void submitEditedArticle() {
        ...
        HelpA.setValueGivenRow(table, currRow, InvoiceB.TABLE_INVOICE_ARTIKLES__MOMS_SATS, map.get(DB.BUH_F_ARTIKEL__MOMS_SATS));
        //
        //
        articlesList.remove(currRow);
        addArticleForDB();
