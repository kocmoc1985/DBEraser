...
public class BUH_INVOICE_MAIN extends javax.swing.JFrame implements MouseListener, KeyListener {
    ...
    private void initComponents() {
        ...
        jButton4_copy = new javax.swing.JButton();
        ...
        jButton4_copy.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/copy.png"))); // NOI18N
        jButton4_copy.setToolTipText("Kopiera faktura");
        jButton4_copy.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton4_copyActionPerformed(evt);
            }
        });
        jPanel4.add(jButton4_copy);
        ...
        jPanel18.setLayout(new java.awt.GridLayout(2, 1, -1, 0));
        ...
        jPanel18.add(jButton4_save_faktura_komment);

        jButton4_delete_faktura_komment1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/close_sm.png"))); // NOI18N
        jButton4_delete_faktura_komment1.setToolTipText("Uppdatera faktura kommentar");
        ...
        jPanel18.add(jButton4_delete_faktura_komment1);
    ...
    private javax.swing.JButton jButton4_copy;
