 ...
 * @author KOCMOC
 */
public class HTMLPrint_B extends javax.swing.JFrame {
    ...
    private String getPathNormal(String pathAndFileName) {
        ...
        try {
            ...
            Logger.getLogger(HTMLPrint_B.class.getName()).log(Level.SEVERE, null, ex);
            return null;
        }
    }
...
//        System.out.println("" + html_);
    ...
    protected URL getImageIconURL(String path, String picName) {
        ...
        return HTMLPrint_B.class.getResource("/" + path + "/" + picName);
    }
...
//            pj.print_java();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new HTMLPrint_B(null, null, null, null, null, null, null, null, null, null, null).setVisible(true);
            }
        });
    }
