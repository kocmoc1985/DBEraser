...
public class DB {
    ...
    public static final String STATIC__BETAL_STATUS = "Nej;0,Ja;1,Delvis;2,Överbetald;3";
    ...
    public static final String PHP_FUNC_PARAM_GET_KUND_ADDRESS = "get_kund_addr"; // using php-function: "select()"
